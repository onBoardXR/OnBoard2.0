import redpoint from "./redpoint.glb";
...
import stgSysClass from "./onBoard/stage-system.js";
import testPersonalCodeClass from "./onBoard/testPersonalcode.js";
import StringsFloormatClass from "./onBoard/strings-floormat.js";
import "./onBoard/smartHome.js";
...
window.stringsFloormat = new StringsFloormatClass();

	// 3.) Initialisation of the class 
window.stgSys.init();

	// 4.) Running of the loop of the class
// Happening at the bottom

	// 5.) Running your functions one by one
// From the stage manager system
