...
//onboard
// == roman
import "../onBoard/stage-system.scss";
// == roman end
//onboard
...
class UIRoot extends Component {
  ...
  render() {
   ...
   window.clap = () => {
     ...
     setTimeout( () => {elt.object3D.position.y = -9999999;}, 5000);
   }
	...
	const helpImg = (
                <img
                    ...
                    style={{position: "absolute", top:"125px", left:"75px",
                           width: "auto", height: "80%", margin: "auto", display:"none"}}
                    onClick={() => window.helpMe()}
                    src= "../assets/onBoard/paybill.png">
                </img>);
